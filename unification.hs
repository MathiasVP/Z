...
unify t1 t2 =
  let
    ...
    uni trace bind1 bind2 (Forall _ t1) t2 =
    ...
    uni _ _ _ (Intersect t1 t2) (Intersect t3 t4) =
  ...
  let
    ...
    uni' trace bind1 bind2 (Record b1 fields1) (Record b2 fields2)
      ...
      where fields1' = List.sortBy (comparing fst) fields1
            ...
            (names1, types1) = List.unzip fields1'
            (names2, types2) = List.unzip fields2'
    uni' trace bind1 bind2 (Arrow tyDom1 tyCod1) (Arrow tyDom2 tyCod2) =
    ...
    uni' trace bind1 bind2 t (Intersect t1 t2) =
      uni' trace bind1 bind2 (Intersect t1 t2) t
    uni' _ _ _ IntType IntType = return $ Just IntType
    uni' _ _ _ RealType RealType = return $ Just RealType
    uni' _ _ _ StringType StringType = return $ Just StringType
    uni' _ _ _ BoolType BoolType = return $ Just BoolType
